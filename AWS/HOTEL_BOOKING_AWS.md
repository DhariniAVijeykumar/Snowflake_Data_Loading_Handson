...
## Architecture
AWS S3 → IAM Role → Storage Integration → External Stage → Snowflake Table
...
1. STORAGE_AWS_ROLE_ARN
2. STORAGE_ALLOWED_LOCATIONS

These values are required for storage integration 
